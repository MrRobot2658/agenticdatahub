# Datalake · 多租户 CDP（对标 Twilio Segment）
...
```bash
# 0. 克隆
git clone https://github.com/MrRobot2658/datalake.git   # 或 SSH: git@github.com:MrRobot2658/datalake.git
cd datalake
...
| MySQL | `localhost:3308` · db `datalake` · user `datalake` / `datalake123` |
