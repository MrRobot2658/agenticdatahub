...
└── src/main/java/com/datalake/flink/
...
# MySQL（发号器）
mysql.jdbc.url=jdbc:mysql://mysql:3306/datalake
mysql.username=datalake
mysql.password=datalake123
...
```bash
flink run -c com.datalake.flink.IdMappingJob \
